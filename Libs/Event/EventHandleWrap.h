...
#ifndef YHLIB_EVENT_CCEVENTHANDLEWRAP_H_
#define YHLIB_EVENT_CCEVENTHANDLEWRAP_H_
...
public:
    ...
    inline void handle(yhlib::Event* event){
        if(m_handle){
...
#endif  // YHLIB_EVENT_CCEVENTHANDLEWRAP_H_
