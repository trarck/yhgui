...
#define YHGUI_VIRTUAL_NEW_AUTORELEASE_CREATE_ELEMENT_METHOD(T) virtual T * createElement(const yhge::Json::Value& defineData) { \
return T::create(); \
}

#define YHGUI_PURE_VIRTUAL_NEW_AUTORELEASE_CREATE_ELEMENT_METHOD(T) virtual T * createElement(const yhge::Json::Value& defineData) = 0
